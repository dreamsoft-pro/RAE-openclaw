...
export function createWebFetchTool(options?: {
  ...
  return {
    ...
    execute: async (_toolCallId, args) => {
      ...
      return await globalGuard.auditedOperation(
        { operationName: "web_fetch", impactLevel: "medium", infoClass: "public" },
        async () => {
          // Hard Frames Security Enforcement: Block internal IPs and suspicious formats
          globalGuard.enforceHardFrames(`fetch ${url}`, { 
