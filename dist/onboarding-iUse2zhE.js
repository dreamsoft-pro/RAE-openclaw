...
import { l as readConfigFileSnapshot, p as writeConfigFile } from "./send-C3_deGKY.js";
import { v as resolveUserPath } from "./utils-DBcXcVLM.js";
...
async function runOnboardingWizard(opts, runtime = defaultRuntime, prompter) {
	const onboardHelpers = await import("./send-C3_deGKY.js").then((n) => n.kt);
	...
	if (mode === "remote") {
		const { promptRemoteGatewayConfig } = await import("./onboard-remote-D03DrfJx.js").then((n) => n.t);
		const { logConfigUpdated } = await import("./logging-BsQ9LERH.js").then((n) => n.r);
	...
	const { promptAuthChoiceGrouped } = await import("./auth-choice-prompt-n3dYZLoT.js").then((n) => n.t);
	const { promptCustomApiConfig } = await import("./onboard-custom-BC6mMbDg.js").then((n) => n.r);
	const { applyAuthChoice, resolvePreferredProviderForAuthChoice, warnIfModelConfigLooksOff } = await import("./auth-choice-CTZk41nn.js").then((n) => n.t);
	const { applyPrimaryModel, promptDefaultModel } = await import("./model-picker-vtJEiLUX.js").then((n) => n.i);
	...
	const { configureGatewayForOnboarding } = await import("./onboarding.gateway-config-Cc73EGku.js");
	...
	if (opts.skipChannels ?? opts.skipProviders) await prompter.note("Skipping channel setup.", "Channels");
		...
		const { listChannelPlugins } = await import("./plugins-9Dsb9585.js").then((n) => n.i);
		const { setupChannels } = await import("./onboard-channels-D6yQUbY1.js").then((n) => n.n);
	...
	if (opts.skipSkills) await prompter.note("Skipping skills setup.", "Skills");
		...
		const { setupSkills } = await import("./onboard-skills-DHPvfWRp.js").then((n) => n.t);
		nextConfig = await setupSkills(nextConfig, workspaceDir, runtime, prompter);
	}
	const { setupInternalHooks } = await import("./onboard-hooks-C9psmrqy.js");
	...
	await writeConfigFile(nextConfig);
	const { finalizeOnboardingWizard } = await import("./onboarding.finalize-CNvIfpM7.js");
