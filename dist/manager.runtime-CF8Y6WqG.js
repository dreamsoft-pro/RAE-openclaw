...
function createDefaultDeps() {
	return {
		whatsapp: createLazySender("whatsapp", () => import("./web-DI7avyYW.js"), "sendMessageWhatsApp"),
		telegram: createLazySender("telegram", () => import("./discord-BOj_XSNV.js").then((n) => n.z), "sendMessageTelegram"),
		discord: createLazySender("discord", () => import("./discord-BOj_XSNV.js").then((n) => n.n), "sendMessageDiscord"),
		slack: createLazySender("slack", () => import("./discord-BOj_XSNV.js").then((n) => n.V), "sendMessageSlack"),
		signal: createLazySender("signal", () => import("./discord-BOj_XSNV.js").then((n) => n.un), "sendMessageSignal"),
		imessage: createLazySender("imessage", () => import("./discord-BOj_XSNV.js").then((n) => n.H), "sendMessageIMessage")
	};
}
//#endregion
