...
import { m_ as readConfigFileSnapshot, v_ as writeConfigFile } from "./reply-cpXZjA1O.js";
...
async function runOnboardingWizard(opts, runtime = defaultRuntime, prompter) {
	const onboardHelpers = await import("./reply-cpXZjA1O.js").then((n) => n.Mt);
	...
	if (mode === "remote") {
		const { promptRemoteGatewayConfig } = await import("./onboard-remote-HmJGoKIg.js").then((n) => n.t);
		const { logConfigUpdated } = await import("./logging-CrOgBVwS.js").then((n) => n.r);
	...
	const { promptAuthChoiceGrouped } = await import("./auth-choice-prompt-CyhDZXQj.js").then((n) => n.t);
	const { promptCustomApiConfig } = await import("./onboard-custom-DuwbZpIg.js").then((n) => n.r);
	const { applyAuthChoice, resolvePreferredProviderForAuthChoice, warnIfModelConfigLooksOff } = await import("./auth-choice-CJVI4Xgt.js").then((n) => n.t);
	const { applyPrimaryModel, promptDefaultModel } = await import("./model-picker-FLhlSmDB.js").then((n) => n.i);
	...
	const { configureGatewayForOnboarding } = await import("./onboarding.gateway-config-C_AQ_nHF.js");
	...
	if (opts.skipChannels ?? opts.skipProviders) await prompter.note("Skipping channel setup.", "Channels");
		...
		const { listChannelPlugins } = await import("./plugins-om7vnHk0.js").then((n) => n.i);
		const { setupChannels } = await import("./onboard-channels-C0QWg4MZ.js").then((n) => n.n);
	...
	if (opts.skipSearch) await prompter.note("Skipping search setup.", "Search");
		...
		const { setupSearch } = await import("./onboard-search-DTTCOCr8.js");
	...
	if (opts.skipSkills) await prompter.note("Skipping skills setup.", "Skills");
		...
		const { setupSkills } = await import("./onboard-skills-Cp8p-rzQ.js").then((n) => n.t);
		nextConfig = await setupSkills(nextConfig, workspaceDir, runtime, prompter);
	}
	const { setupInternalHooks } = await import("./onboard-hooks-DUll1iq8.js");
	...
	await writeConfigFile(nextConfig);
	const { finalizeOnboardingWizard } = await import("./onboarding.finalize-Bq4IhQHR.js");
