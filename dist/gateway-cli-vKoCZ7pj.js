...
import { $a as buildChannelUiCatalog, $c as validateNodeEventParams, $h as cleanOldMedia, $l as deriveDeviceIdFromPublicKey, $n as formatZonedTimestamp, $o as buildSafeExternalPrompt, $r as resolveGroupToolPolicy, $s as APPROVALS_SCOPE$1, $t as getChannelActivity, A as normalizeModelSelection, Ac as validateConnectParams, Ad as getAcpSessionManager, Af as textToSpeech, Al as validateTalkConfigParams, Am as stripInlineDirectiveTagsFromMessageForDisplay, An as parseVerboseOverride, Ao as normalizeCronJobPatch, Ar as stopSubagentsForRequester, As as resolveSystemRunApprovalRuntimeContext, Av as normalizeVerboseLevel, B as resolveThinkingDefault, Bc as validateDevicePairRejectParams, Bg as normalizeRateLimitClientIp, Bh as createBrowserRouteDispatcher, Bl as validateWizardStatusParams, Bm as setSessionRuntimeModel, Bn as approveNodePairing, Bt as CONTROL_UI_AVATAR_PREFIX, Cc as validateConfigApplyParams, Cf as resolveTtsApiKey, Ch as createAsyncLock, Ci as onAgentEvent, Cl as validateSessionsResetParams, Cm as cleanupArchivedSessionTranscripts, Cn as setCliSessionId, Co as formatRestartSentinelMessage, Cr as normalizeSendPolicy, Dc as validateConfigSchemaLookupResult, Dd as SILENT_REPLY_TOKEN, Df as resolveTtsProviderOrder, Dg as authorizeWsControlUiGatewayConnect, Dl as validateSkillsInstallParams, Dm as stripEnvelopeFromMessage, Do as writeRestartSentinel, Dv as normalizeReasoningLevel, E as isCliProvider, Ec as validateConfigSchemaLookupParams, Ef as resolveTtsPrefsPath, Eg as authorizeHttpGatewayConnect, El as validateSkillsBinsParams, Em as resolveSessionTranscriptCandidates, Et as handleReset, Eu as saveExecApprovals, Ev as normalizeFastMode, F as resolveConfiguredModelRef, Fa as resolveSessionDeliveryTarget, Fc as validateCronRunsParams, Fi as loadProviderUsageSummary, Fl as validateWebLoginStartParams, Fn as recordRemoteNodeInfo, Fo as normalizeOptionalAgentId, Fr as abortEmbeddedPiRun, Fs as missingSystemRunApprovalBinding, Fv as DEFAULT_PROVIDER, Gc as validateExecApprovalResolveParams, Gg as isTrustedProxyAddress, Gi as migrateAndPruneGatewaySessionStoreKey, Gl as resolveAuthConnectErrorDetailCode, Gm as resolveMainSessionKeyFromConfig, Gn as updatePairedNodeMetadata, Gr as resolveCronStyleNow, Gt as resolveExecApprovalCommandDisplay, H as loadOpenClawPlugins, Hc as validateDeviceTokenRevokeParams, Hg as isLoopbackAddress, Hh as startBrowserControlServiceFromConfig, Hi as listSessionsFromStore, Hl as errorShape, Hm as resolveAgentMainSessionKey, Hn as rejectNodePairing, Ho as normalizeLegacyDeliveryInput, Hr as resolveFastModeState, Ht as normalizeControlUiBasePath, I as resolveDefaultModelForAgent, Ic as validateCronStatusParams, Ig as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN, Il as validateWebLoginWaitParams, Im as resolveSessionResetPolicy, In as refreshRemoteBinsForConnectedNodes, Io as normalizeOptionalSessionKey, Ir as getActiveEmbeddedRunCount, J as formatHelpExamples, Jc as validateExecApprovalsNodeSetParams, Jf as extractTextFromChatContent, Jg as pickPrimaryLanIPv4, Ji as AVATAR_MAX_BYTES, Jl as buildDeviceAuthPayloadV3, Jr as applyToolPolicyPipeline, K as withProgress, Kc as validateExecApprovalsGetParams, Kg as isValidIPv4, Kh as movePathToTrash, Ki as resolveGatewaySessionStoreTarget, Kl as resolveDeviceAuthConnectErrorDetailCode, Km as snapshotSessionOrigin, Kn as verifyNodeToken, Kt as sanitizeExecApprovalDisplayText, L as resolveHooksGmailModel, La as buildOutboundSessionContext, Lc as validateCronUpdateParams, Lg as AUTH_RATE_LIMIT_SCOPE_HOOK_AUTH, Ll as validateWizardCancelParams, Ln as refreshRemoteNodeBins, Lo as normalizeOptionalText$1, Lr as waitForActiveEmbeddedRuns, Ls as toSystemRunApprovalMismatchError, Mc as validateCronListParams, Mf as OPENAI_TTS_VOICES, Mi as resolveNestedAgentLane, Ml as validateToolsCatalogParams, Mm as jsonUtf8Bytes, Mo as resolveCronStaggerMs, Ms as resolveSystemRunCommandRequest, Mv as supportsXHighThinking, N as resolveAllowedModelRef, Nc as validateCronRemoveParams, Ng as readGatewayPasswordEnv, Ni as resolvePreferredSessionKeyForSessionIdMatches, Nl as validateUpdateRunParams, Nn as getRemoteSkillEligibility, No as resolveDefaultCronStaggerMs, Nr as runEmbeddedPiAgent, Ns as buildSystemRunApprovalBinding, Oc as validateConfigSchemaParams, Of as setTtsEnabled, Og as isLocalDirectRequest, Oi as readLatestAssistantReply, Ol as validateSkillsStatusParams, Om as stripEnvelopeFromMessages, Oo as normalizeHttpWebhookUrl, Ou as getPluginToolMeta, Ov as normalizeThinkLevel, Pa as resolveOutboundTarget, Pc as validateCronRunParams, Pg as readGatewayTokenEnv, Pi as applyModelOverrideToSessionEntry, Pl as validateWakeParams, Pm as evaluateSessionFreshness, Pn as primeRemoteSkillsCache, Ps as matchSystemRunApprovalBinding, Pv as DEFAULT_MODEL, Qc as validateNodeDescribeParams, Qd as readChannelAllowFromStoreSync, Qg as resolveRequestClientIp, Qh as rawDataToString, Ql as loadGatewayTlsRuntime$1, Qn as listAgentWorkspaceDirs, Qr as resolveEffectiveToolPolicy, Qs as ADMIN_SCOPE$3, Qu as resolveUserTimezone, Ra as deliverOutboundPayloads, Rc as validateDevicePairApproveParams, Rg as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, Rl as validateWizardNextParams, Rm as mergeSessionEntry, Rn as removeRemoteNodeInfo, Ro as normalizePayloadToSystemText, Rr as waitForEmbeddedPiRunEnd, S as buildAllowedModelSet, S_ as PROFILE_OPTIONS, Sc as validateChatSendParams, Sd as getMachineDisplayName, Sf as isTtsProviderConfigured, Sh as cleanStaleLockFiles, Si as getAgentRunContext, Sl as validateSessionsPreviewParams, Sm as capArrayByJsonBytes, Sn as getCliSessionId, So as formatDoctorNonInteractiveHint, Sv as formatXHighModelHint, T as getModelRefStatus, T_ as resolveCoreToolProfiles, Tc as validateConfigPatchParams, Td as stripHeartbeatToken, Tf as resolveTtsConfig, Tg as assertGatewayAuthConfigured, Th as writeJsonAtomic, Tl as validateSessionsUsageParams, Tm as readSessionPreviewItemsFromTranscript, To as summarizeRestartSentinel, Tv as normalizeElevatedLevel, U as createPluginRuntime, Ua as normalizeReplyPayloadsForDelivery, Uc as validateDeviceTokenRotateParams, Ug as isLoopbackHost, Ui as loadCombinedSessionStoreForGateway, Ul as parseSessionLabel, Um as resolveExplicitAgentSessionKey, Un as renamePairedNode, Ut as resolveAssistantAvatarUrl, Vc as validateDevicePairRemoveParams, Vg as isLocalishHost, Vh as createBrowserControlContext, Vi as listAgentsForGateway, Vl as ErrorCodes, Vm as canonicalizeMainSessionAlias, Vn as listNodePairing, Vo as parseAbsoluteTimeMs, Vr as resolveBootstrapWarningSignaturesSeen, Vs as ToolInputError, Vt as buildControlUiAvatarUrl, Wc as validateExecApprovalRequestParams, Wi as loadSessionEntry, Wl as ConnectErrorDetailCodes, Wm as resolveMainSessionKey, Wn as requestNodePairing, Xa as applyPluginAutoEnable, Xc as validateLogsTailParams, Xg as resolveGatewayBindHost, Xi as isAvatarImageDataUrl, Ya as resolveOutboundChannelPlugin, Yc as validateExecApprovalsSetParams, Yf as fetchWithSsrFGuard, Yg as resolveClientIp, Yi as isAvatarHttpUrl, Yl as normalizeDeviceMetadataForAuth, Yr as buildDefaultToolPolicyPipelineSteps, Zc as validateModelsListParams, Zf as registerUnhandledRejectionHandler, Zg as resolveGatewayListenHosts, Zi as looksLikeAvatarPath, Zl as normalizeDeviceAuthScopes, Zu as applyMergePatch, _c as validateChannelsLogoutParams, _g as ensureGatewayStartupAuth, _h as normalizeGatewayClientMode, _i as resolveIngressWorkspaceOverrideForSpawnedRun, _l as validateSendParams, _m as mergeDeliveryContext, _o as scheduleGatewaySigusr1Restart, _r as DEFAULT_INPUT_TIMEOUT_MS, a as createConfigIO, aa as clearSessionQueues, ah as isDeliverableMessageChannel, al as validateNodePairRejectParams, am as archiveRemovedSessionTranscripts, ao as normalizePollInput, as as persistBrowserProxyFiles, b_ as mergeAlsoAllowPolicy, ba as ensureOutboundSessionEntry, bc as validateChatHistoryParams, bf as getTtsProvider, bg as resolveConfiguredSecretInputString, bi as clearAgentRunContext, bl as validateSessionsListParams, bm as archiveFileOnDisk, bn as resolveCronStorePath, bo as triggerOpenClawRestart, br as normalizeMimeList, bv as normalizeSecretInput, c as readBestEffortConfig, c_ as disableTailscaleFunnel, cc as validateAgentParams, cd as resetAllLanes, cf as isSystemEventContextChanged, cl as validateNodePendingAckParams, cs as getActiveSecretsRuntimeSnapshot, d as resolveConfigSnapshotHash, d_ as enableTailscaleServe, da as normalizeGroupActivation, dc as validateAgentsDeleteParams, dd as CommandLane, dl as validateNodeRenameParams, dn as buildHistoryContextFromEntries, dp as runGlobalGatewayStopSafely, ds as GATEWAY_AUTH_SURFACE_PATHS, du as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS, e_ as pickPrimaryTailnetIPv4, ea as lookupContextTokens, ec as PAIRING_SCOPE$1, ei as resolveSubagentToolPolicy, el as validateNodeInvokeParams, em as resolveAgentSessionDirs, ep as loadModelCatalog, es as detectSuspiciousPatterns, eu as loadOrCreateDeviceIdentity, fc as validateAgentsFilesGetParams, fh as GATEWAY_CLIENT_CAPS, fl as validatePollParams, fo as consumeGatewaySigusr1RestartAuthorization, fr as resolveSessionAuthProfileOverride, fs as evaluateGatewayAuthSurfaceStates, ft as resolveAgentOutboundIdentity, gc as validateAgentsUpdateParams, gd as isDiagnosticsEnabled, gh as hasGatewayClientCap, gi as normalizeSpawnedRunMetadata, gl as validateSecretsResolveResult, gm as deliveryContextFromSession, gn as getTotalPendingReplies, go as markGatewaySigusr1RestartHandled, gr as DEFAULT_INPUT_IMAGE_MIMES, gu as mergeExecApprovalsSocketDefaults, h as OpenClawSchema, hc as validateAgentsListParams, hh as GATEWAY_CLIENT_NAMES, hl as validateSecretsResolveParams, hn as createReplyDispatcher, ho as isGatewaySigusr1RestartExternallyAllowed, hr as DEFAULT_INPUT_IMAGE_MAX_BYTES, hs as isKnownSecretTargetId, hv as isPidAlive, i as migrateLegacyConfig, ic as isNodeRoleMethod, id as getActiveTaskCount, ih as INTERNAL_MESSAGE_CHANNEL, ii as countActiveDescendantRuns, il as validateNodePairListParams, io as resolveMessageChannelSelection, is as applyBrowserProxyPaths, iu as verifyDeviceSignature, jc as validateCronAddParams, jf as OPENAI_TTS_MODELS, jl as validateTalkModeParams, jm as normalizeInputProvenance, jn as unbindThreadBindingsBySessionKey, jo as normalizeCronStaggerMs, kc as validateConfigSetParams, kd as isSilentReplyText, kf as setTtsProvider, kg as resolveGatewayAuth, ki as resolveAnnounceTargetFromKey, kl as validateSkillsUpdateParams, km as stripInlineDirectiveTagsForDisplay, kn as applyVerboseOverride, ko as normalizeCronJobCreate, kr as isAbortRequestText, ks as resolveSystemRunApprovalRequestContext, ku as resolvePluginTools, kv as normalizeUsageDisplay, l as readConfigFileSnapshot, l_ as disableTailscaleServe, lc as validateAgentWaitParams, ld as setCommandLaneConcurrency, lh as isWebchatClient, li as listDescendantRunsForRequester, ll as validateNodePendingDrainParams, ln as createReplyPrefixOptions, lr as getSkillsSnapshotVersion, ls as prepareSecretsRuntimeSnapshot, lt as buildTelegramExecApprovalButtons, lu as setHeartbeatsEnabled, m as validateConfigObjectWithPlugins, mc as validateAgentsFilesSetParams, md as stopDiagnosticHeartbeat, mg as SsrFBlockedError, mh as GATEWAY_CLIENT_MODES, mi as resolveAgentTimeoutMs, ml as validateRequestFrame, mm as parseByteSize, mn as dispatchInboundMessage, mo as emitGatewayRestart, mt as handleSlackHttpRequest, na as computeBackoff, nc as WRITE_SCOPE, nd as clearBootstrapSnapshotOnSessionRollover, ni as runBeforeToolCallHook, nl as validateNodeListParams, nm as extractDeliveryInfo, nn as resolveAgentAvatar, no as maybeResolveIdLikeTarget, ns as isExternalHookSession, nu as publicKeyRawBase64UrlFromPem, o as loadConfig, oc as formatValidationErrors, od as getTotalQueueSize, oh as isGatewayCliClient, ol as validateNodePairRequestParams, om as loadSessionStore, os as activateSecretsRuntimeSnapshot, p as writeConfigFile, p_ as getTailnetHostname, pc as validateAgentsFilesListParams, pd as startDiagnosticHeartbeat, ph as GATEWAY_CLIENT_IDS, pl as validatePushTestParams, po as deferGatewayRestartUntilIdle, pu as ensureExecApprovals, qc as validateExecApprovalsNodeGetParams, qg as normalizeHostHeader, qi as resolveSessionModelRef, ql as buildDeviceAuthPayload, qp as estimateBase64DecodedBytes, qr as resolveToolLoopDetectionConfig, qs as callGateway, ra as sleepWithAbort, rc as authorizeOperatorScopesForMethod, rd as enqueueCommandInLane, ri as createOpenClawTools, rl as validateNodePairApproveParams, rm as parseSessionThreadInfo, ro as resetDirectoryCache, rs as closeTrackedBrowserTabsForSessions, s as parseConfigJson5, s_ as safeEqualSecret, sa as resolveAgentIdentity, sc as validateAgentIdentityParams, sd as markGatewayDraining, sf as enqueueSystemEvent, sh as isGatewayMessageChannel, si as initSubagentRegistry, sl as validateNodePairVerifyParams, so as runWithModelFallback, ss as clearSecretsRuntimeSnapshot, st as sendTypingTelegram, su as requestHeartbeatNow, t_ as pickPrimaryTailnetIPv6, td as clearBootstrapSnapshot, tl as validateNodeInvokeResultParams, ts as getHookType, tu as normalizeDevicePublicKeyBase64Url, u as readConfigFileSnapshotForWrite, u_ as enableTailscaleFunnel, uc as validateAgentsCreateParams, ud as waitForActiveTasks, uh as normalizeMessageChannel, ul as validateNodePendingEnqueueParams, um as updateSessionStore, uo as resolveFailoverReasonFromError, up as getGlobalHookRunner, ur as registerSkillsChangeListener, us as resolveCommandSecretsFromActiveRuntimeSnapshot, ut as resolveExecApprovalSessionTarget, v as applyLegacyMigrations, va as parseTimeoutMsWithFallback, vc as validateChannelsStatusParams, vg as mergeGatewayAuthConfig, vi as resolveAgentMaxConcurrent, vl as validateSessionsCompactParams, vm as normalizeSessionDeliveryFields, vn as buildBareSessionResetPrompt, vo as setGatewaySigusr1RestartPolicy, vr as extractFileContentFromSource, vu as normalizeExecApprovals, w_ as listCoreToolSections, wc as validateConfigGetParams, wf as resolveTtsAutoMode, wh as readJsonFile, wi as registerAgentRunContext, wl as validateSessionsResolveParams, wm as readSessionMessages, wn as runCliAgent, wr as resolveSendPolicy, x as buildTalkConfigResponse, x_ as resolveToolProfilePolicy, xa as resolveOutboundSessionRoute, xc as validateChatInjectParams, xd as resolveMemorySearchConfig, xf as isTtsEnabled, xi as emitAgentEvent, xl as validateSessionsPatchParams, xm as archiveSessionTranscripts, xn as saveCronStore, xo as consumeRestartSentinel, xr as resolveInputFileLimits, xu as readExecApprovalsSnapshot, xv as formatThinkingLevels, y as ensureControlUiAllowedOriginsForNonLoopbackBind, y_ as collectExplicitAllowlist, yc as validateChatAbortParams, yg as mergeGatewayTailscaleConfig, yi as resolveSubagentMaxConcurrent, yl as validateSessionsDeleteParams, yn as loadCronStore, yo as setPreRestartDeferralCheck, yr as extractImageContentFromSource, z as resolveSubagentConfiguredModelSelection, zc as validateDevicePairListParams, zd as isRestartEnabled, zg as createAuthRateLimiter, zi as canonicalizeSpawnedByForAgent, zl as validateWizardStartParams, zn as setSkillsRemoteRegistry, zo as normalizeRequiredName, zs as buildExecApprovalPendingReplyPayload } from "./send-C3_deGKY.js";
import { E as isPlainObject, S as sleep, T as truncateUtf16Safe, n as clamp, s as ensureDir, v as resolveUserPath, x as shortenHomePath } from "./utils-DBcXcVLM.js";
import "./env-overrides-DWTUPhKx.js";
import { n as resolveRuntimeServiceVersion, t as VERSION } from "./version-D0tcvzW0.js";
...
import { i as logWarn, t as logDebug } from "./logger-6-BbUobc.js";
import { n as runExec, t as runCommandWithTimeout } from "./exec-CLorXZJE.js";
...
import { t as formatCliCommand } from "./command-format-DTVtsTWP.js";
import { $ as writeFileWithinRoot, J as openFileWithinRoot, N as detectMime, W as SafeOpenError, Z as readLocalFileSafely } from "./query-expansion-Cd6sO7e-.js";
import { Y as buildChannelAccountBindings, b as resolveWhatsAppAccount, g as resolveChannelDefaultAccountId, m as normalizeWhatsAppTarget, n as listChannelPlugins, r as normalizeChannelId, t as getChannelPlugin } from "./plugins-9Dsb9585.js";
import { a as testRegexWithBoundedInput, i as compileSafeRegex } from "./redact-Dwh0T4LH.js";
import { A as triggerInternalHook, D as clearInternalHooks, O as createInternalHookEvent, b as canonicalizePathVariant, h as createEmptyPluginRegistry, k as registerInternalHook, t as CHANNEL_IDS, u as getActivePluginRegistry, v as PROTECTED_PLUGIN_ROUTE_PREFIXES, y as canonicalizePathForSecurity } from "./registry-Cmzp1GgU.js";
import { p as hasBinary } from "./frontmatter-0S6BwMCg.js";
import { n as assertNoPathAliasEscape } from "./path-alias-guards-D0OaD7WI.js";
import { i as loadWorkspaceSkillEntries, r as buildWorkspaceSkillSnapshot, y as isTestDefaultMemorySlotDisabled } from "./skills-Dm6Oukfq.js";
import "./fetch-BiG0XwdQ.js";
import { o as isErrno, r as formatErrorMessage } from "./errors-DpLnShUX.js";
import { c as inspectPortUsage, d as formatPortDiagnostics, s as ensurePortAvailable } from "./cmd-argv-DyLQYBHg.js";
import { t as cleanStaleGatewayProcessesSync } from "./restart-stale-pids-DVmesqGw.js";
import "./delivery-queue-BC7FiiKY.js";
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-CtLQlqaT.js";
import { c as formatUsd, d as deriveSessionTotalTokens, f as hasNonzeroUsage, i as loadSessionUsageTimeSeries, n as loadCostUsageSummary, r as loadSessionCostSummary, s as formatTokenCount, t as discoverAllSessions } from "./session-cost-usage-CSeJhdaB.js";
import { a as parseDurationMs, r as resolveMemoryBackendConfig, t as getMemorySearchManager } from "./search-manager-rcsEvvDP.js";
...
import { n as createDefaultDeps, r as createOutboundSendDeps$1, t as createOutboundSendDeps } from "./outbound-send-deps-BdJDUpuW.js";
import { a as resolveAgentOutboundTarget, i as resolveAgentDeliveryPlan, n as agentCommandFromIngress } from "./agent-MgIxu9mo.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-UfQ96KLO.js";
import { i as onHeartbeatEvent, r as getLastHeartbeatEvent, t as resolveHeartbeatVisibility } from "./heartbeat-visibility-CPv4HIMn.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-D0WOmKhk.js";
import { n as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-DqZ6u2zf.js";
import { t as readSecretFromFile } from "./secret-file-CdzCQ9fk.js";
import { n as inheritOptionFromParent } from "./command-options-D5e0M0E1.js";
import { t as WizardCancelledError } from "./prompts-BhCzirl1.js";
import { a as pruneAgentConfig, i as loadAgentIdentity, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-BvLztaxj.js";
import { t as isWithinDir } from "./path-safety-7PqULVUC.js";
import "./install-safe-path-CtDaSeA7.js";
import "./skill-scanner-Np35A8Vt.js";
import { n as formatConfigIssueLines } from "./issue-format-DH5_IVWj.js";
import { t as buildChannelAccountSnapshot } from "./status-BOHSKeHd.js";
import "./channels-status-issues-B7XaO_eL.js";
import { n as verifyDeviceBootstrapToken } from "./device-bootstrap-8StqluiZ.js";
import { a as buildBaseHints, i as applySensitiveHints, n as redactConfigSnapshot, o as mapSensitivePaths, r as restoreRedactedValues, s as applyDerivedTags, t as redactConfigObject } from "./redact-snapshot-DNO7hODG.js";
...
import { p as scheduleDetachedLaunchdRestartHandoff } from "./launchd-DaQfJlhP.js";
import { c as isGatewayArgv, l as parseProcCmdline } from "./service-CXKirQDx.js";
import "./systemd-D38NY5Ac.js";
import "./lifecycle-core-BDO6MPkC.js";
import "./systemd-hints-DyGeJ1h5.js";
import { t as parsePort$1 } from "./parse-port-CZos_Guw.js";
import { n as addGatewayServiceCommands } from "./daemon-cli-YcdNGlwx.js";
import { r as probeGateway } from "./probe-auth-Bx0GNUeY.js";
import "./diagnostics-BYQRViUe.js";
import "./inspect-gI_1Titf.js";
import { a as rejectDevicePairing, c as revokeDeviceToken, d as updatePairedDeviceMetadata, f as verifyDeviceToken, i as listDevicePairing, l as rotateDeviceToken, n as ensureDeviceToken, o as removePairedDevice, p as roleScopesAllow, r as getPairedDevice, s as requestDevicePairing, t as approveDevicePairing, u as summarizeDeviceTokens } from "./device-pairing-BQUalvOI.js";
import "./table-BwrzV4ON.js";
import { n as resolveWideAreaDiscoveryDomain, r as writeWideAreaGatewayZone } from "./widearea-dns-C3aDWEd2.js";
import { i as toOptionString, n as extractGatewayMiskeys, r as maybeExplainGatewayServiceStop, t as describeUnknownError } from "./shared-BHrxGSY4.js";
import { t as discoverGatewayBeacons } from "./bonjour-discovery-DbODs9uo.js";
import { i as pickGatewaySelfPresence, r as getStatusSummary } from "./status-Cz4yIub9.js";
import { a as styleHealthChannelLine, c as startHeartbeatRunner, n as getHealthSnapshot, s as runHeartbeatOnce, t as formatHealthChannelLines } from "./health-BKC_wxhS.js";
import { a as resolveControlUiRootOverrideSync, n as isPackageProvenControlUiRootSync, o as resolveControlUiRootSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-BRCAG5mx.js";
import { m as normalizeUpdateChannel, n as checkUpdateStatus, o as resolveNpmChannelTag, r as compareSemverStrings } from "./channel-account-context-B6QyDSD-.js";
import "./onboarding.secret-input-D6xkmKKt.js";
import { t as runOnboardingWizard } from "./onboarding-iUse2zhE.js";
import { a as resolveApnsAuthConfigFromEnv, c as shouldClearStoredApnsRegistration, d as parseMessageWithAttachments, f as formatForLog, g as setGatewayWsLogStyle, h as summarizeAgentEventForWsLog, l as resolveApnsRelayConfigFromEnv, m as shouldLogWs, n as loadApnsRegistration, o as sendApnsAlert, p as logWs, r as normalizeApnsEnvironment, s as sendApnsBackgroundWake, t as clearApnsRegistrationIfCurrent, u as normalizeRpcAttachmentsToChatAttachments } from "./push-apns-DVp_nypa.js";
import { _ as buildGogWatchStartArgs, g as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, w as resolveGmailHookRuntimeConfig } from "./gmail-setup-utils-DE4d7qRe.js";
import { f as normalizeStoredCronJobs, h as computePreviousRunAtMs, m as computeNextRunAtMs, p as coerceFiniteScheduleNumber, t as runGatewayUpdate } from "./update-runner-LEjsEVXC.js";
import { n as isNodeCommandAllowed, r as resolveNodeCommandAllowlist } from "./node-command-policy-C05zydiF.js";
...
import "./node-service-B-jB9xrP.js";
import "./status.update-C89RKECE.js";
import { t as installSkill } from "./skills-install-CTSRMPTB.js";
import { i as shouldIncludeHook, r as resolveHookConfig, t as loadWorkspaceHookEntries } from "./workspace-Ccuv64Qb.js";
import { n as forceFreePortAndWait, r as waitForPortBindable } from "./ports-CUNCua9V.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-1i8wlmR0.js");
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		if (!resolved) return;
		const { config, entry, agentId, sessionId, sessionFile } = resolved;
		const { loadSessionLogs } = await import("./session-cost-usage-CSeJhdaB.js").then((n) => n.a);
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./server-Lh2192R1.js");
	...
	socket.on("message", async (data) => {
		...
		try {
			...
			if (!client) {
				...
				const skipPairing = resolvedAuth.mode === "none" || shouldSkipBackendSelfPairing({
					connectParams,
					isLocalClient,
					hasBrowserOriginHeader,
					sharedAuthOk,
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	if (!minimalTestGateway) (async () => {
		const { recoverPendingDeliveries } = await import("./delivery-queue-BC7FiiKY.js").then((n) => n.n);
		const { deliverOutboundPayloads } = await import("./send-C3_deGKY.js").then((n) => n.za);
