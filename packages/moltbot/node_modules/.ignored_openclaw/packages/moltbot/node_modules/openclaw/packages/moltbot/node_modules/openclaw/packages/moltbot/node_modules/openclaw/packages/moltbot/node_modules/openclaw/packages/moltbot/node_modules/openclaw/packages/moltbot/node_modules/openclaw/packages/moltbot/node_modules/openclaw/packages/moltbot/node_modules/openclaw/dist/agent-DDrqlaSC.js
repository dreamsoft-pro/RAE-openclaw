...
function createDefaultDeps() {
	return {
		whatsapp: createLazySender("whatsapp", () => import("./web-Bg03B1od.js"), "sendMessageWhatsApp"),
		telegram: createLazySender("telegram", () => import("./model-selection-B39RkaPd.js").then((n) => n.g), "sendMessageTelegram"),
		discord: createLazySender("discord", () => import("./model-selection-B39RkaPd.js").then((n) => n.yn), "sendMessageDiscord"),
		slack: createLazySender("slack", () => import("./model-selection-B39RkaPd.js").then((n) => n.v), "sendMessageSlack"),
		signal: createLazySender("signal", () => import("./model-selection-B39RkaPd.js").then((n) => n.Rt), "sendMessageSignal"),
		imessage: createLazySender("imessage", () => import("./model-selection-B39RkaPd.js").then((n) => n.y), "sendMessageIMessage")
	};
}
//#endregion
