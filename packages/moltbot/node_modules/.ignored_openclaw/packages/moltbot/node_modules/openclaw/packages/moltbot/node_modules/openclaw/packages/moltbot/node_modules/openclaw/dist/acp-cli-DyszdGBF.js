...
import { Dg as isKnownCoreToolId, Tm as GATEWAY_CLIENT_NAMES, Vv as listThinkingLevels, Xt as resolveGatewayConnectionAuth, d_ as loadConfig, dv as VERSION, hs as GatewayClient, ns as buildGatewayConnectionDetails, wm as GATEWAY_CLIENT_MODES } from "./reply-cpXZjA1O.js";
...
import { M as resolveWindowsSpawnProgram, j as materializeWindowsSpawnProgram } from "./query-expansion-BNb6Vys6.js";
...
import { i as omitEnvKeysCaseInsensitive, n as listKnownProviderAuthEnvVarNames } from "./provider-env-vars-UMPrp98I.js";
import { t as DANGEROUS_ACP_TOOLS } from "./dangerous-tools-GYTW9RSz.js";
...
async function createAcpClient(opts = {}) {
	...
	const { getActiveSkillEnvKeys } = await import("./env-overrides.runtime-BuJGqw7k.js");
