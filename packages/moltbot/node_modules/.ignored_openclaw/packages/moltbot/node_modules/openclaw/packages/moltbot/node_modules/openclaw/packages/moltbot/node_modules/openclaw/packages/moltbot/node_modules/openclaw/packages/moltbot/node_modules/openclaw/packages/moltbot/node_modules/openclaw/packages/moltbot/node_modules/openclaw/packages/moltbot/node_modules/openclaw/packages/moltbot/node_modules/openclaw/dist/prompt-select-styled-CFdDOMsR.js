import { N as getResolvedLoggerSettings, p as defaultRuntime } from "./subsystem-BKSEV_2a.js";
...
import { A_ as resolveBootstrapMaxChars, Br as buildBootstrapInjectionStats, Dn as buildAuthHealthSummary, E_ as DEFAULT_SANDBOX_BROWSER_IMAGE, En as DEFAULT_OAUTH_WARN_MS, F as resolveConfiguredModelRef, Fv as DEFAULT_PROVIDER, Gd as resolveDmAllowState, H as loadOpenClawPlugins, Kp as resolveProfileUnusableUntilForDisplay, Ks as buildGatewayConnectionDetails, L as resolveHooksGmailModel, Nt as randomToken, O_ as DEFAULT_SANDBOX_IMAGE, On as formatRemainingShort, P_ as resolveApiKeyForProfile, Pg as readGatewayTokenEnv, Pv as DEFAULT_MODEL, Sh as cleanStaleLockFiles, T as getModelRefStatus, Tt as guardCancel, Ug as isLoopbackHost, Wm as resolveMainSessionKey, Xg as resolveGatewayBindHost, __ as resolveSandboxScope, _v as CLAUDE_CLI_PROFILE_ID, bd as hasConfiguredMemorySecretInput, bn as resolveCronStorePath, bt as applyWizardMetadata, dv as updateAuthProfileStoreWithLock, ed as resolveBootstrapContextForRun, em as resolveAgentSessionDirs, ep as loadModelCatalog, j_ as resolveBootstrapTotalMaxChars, jt as printWizardHeader, kg as resolveGatewayAuth, l as readConfigFileSnapshot, nh as isPrimarySessionTranscriptFileName, om as loadSessionStore, op as resolveApiKeyForProvider, p as writeConfigFile, qs as callGateway, rv as repairOAuthProfileIdMismatch, sv as ensureAuthProfileStore, th as formatSessionArchiveTimestamp, vv as CODEX_CLI_PROFILE_ID, wg as hasAmbiguousGatewayAuthModeConfig, xd as resolveMemorySearchConfig, xg as resolveConfiguredSecretInputWithFallback, xn as saveCronStore, yn as loadCronStore, zr as analyzeBootstrapBudget } from "./send-C3_deGKY.js";
import { S as sleep, v as resolveUserPath, x as shortenHomePath } from "./utils-DBcXcVLM.js";
import { E as parseAgentSessionKey } from "./session-key-51LnISpq.js";
import { _ as DEFAULT_AGENTS_FILENAME, a as resolveAgentDir, d as resolveAgentWorkspaceDir, f as resolveDefaultAgentId } from "./agent-scope-CwU5BIqj.js";
...
import { n as listChannelPlugins } from "./plugins-9Dsb9585.js";
import { a as isWSLEnv, i as isWSL } from "./fetch-BiG0XwdQ.js";
import { c as inspectPortUsage, d as formatPortDiagnostics } from "./cmd-argv-DyLQYBHg.js";
import { c as resolveSessionTranscriptsDirForAgent, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-CtLQlqaT.js";
import { f as resolveGatewaySystemdServiceName, h as resolveNodeLaunchAgentLabel, l as resolveGatewayLaunchAgentLabel, p as resolveGatewayWindowsTaskName } from "./constants-w22BuGMD.js";
import { r as resolveMemoryBackendConfig } from "./search-manager-rcsEvvDP.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-DF1oEAAo.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-UfQ96KLO.js";
import { t as note$1 } from "./note-D8VBKvW3.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-B7XaO_eL.js";
import { a as renderSystemNodeWarning, o as resolveSystemNodeInfo } from "./daemon-install-plan.shared-CYiptEdb.js";
...
import { n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-CjlHpTU-.js";
import { i as launchAgentPlistExists, n as isLaunchAgentListed, r as isLaunchAgentLoaded, s as repairLaunchAgentBootstrap } from "./launchd-DaQfJlhP.js";
import { n as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-CXKirQDx.js";
import { i as isSystemdUserServiceAvailable, u as uninstallLegacySystemdUnits } from "./systemd-D38NY5Ac.js";
import { c as buildPlatformRuntimeLogHints, i as auditGatewayServiceConfig, n as renderSystemdUnavailableHints, o as needsNodeRuntimeMigration, r as SERVICE_AUDIT_CODES, s as readEmbeddedGatewayToken, t as isSystemdUnavailableDetail, u as formatRuntimeStatus } from "./systemd-hints-DyGeJ1h5.js";
import { n as readLastGatewayErrorLine } from "./diagnostics-BYQRViUe.js";
import { n as renderGatewayServiceCleanupHints, t as findExtraGatewayServices } from "./inspect-gI_1Titf.js";
import { r as healthCommand } from "./health-BKC_wxhS.js";
import { i as resolveControlUiDistIndexPathForRoot, r as resolveControlUiDistIndexHealth } from "./control-ui-assets-BRCAG5mx.js";
import { t as resolveDefaultChannelAccountContext } from "./channel-account-context-B6QyDSD-.js";
import { f as normalizeStoredCronJobs, t as runGatewayUpdate } from "./update-runner-LEjsEVXC.js";
import { n as logConfigUpdated } from "./logging-BsQ9LERH.js";
import { n as noteOpenAIOAuthTlsPrerequisites } from "./oauth-tls-preflight-qjNCqUn-.js";
import { n as detectLegacyStateMigrations, r as runLegacyStateMigrations, t as loadAndMaybeMigrateDoctorConfig } from "./doctor-config-flow-7qoPM8o_.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-CVXfcOJY.js";
import { t as formatHealthCheckFailure } from "./health-format-BCXrKz71.js";
import { n as doctorShellCompletion } from "./doctor-completion-OJOkKEPD.js";
