import { A as theme, O as colorize, k as isRich$1 } from "./subsystem-BKSEV_2a.js";
import "./paths-dQ_clcF4.js";
import "./boolean-BHdNsbzF.js";
import { At as openUrl, B_ as resolveSecretRefString, C as buildModelAliasIndex, Dn as buildAuthHealthSummary, En as DEFAULT_OAUTH_WARN_MS, F as resolveConfiguredModelRef, Fi as loadProviderUsageSummary, Fv as DEFAULT_PROVIDER, Gp as clearAuthProfileCooldown, I as resolveDefaultModelForAgent, Ip as isNonSecretApiKeyMarker, Kp as resolveProfileUnusableUntilForDisplay, Lf as discoverAuthStorage, Li as formatUsageWindowSummary, Lv as getShellEnvAppliedKeys, M as parseModelRef, Nr as runEmbeddedPiAgent, O as modelKey, On as formatRemainingShort, Pf as resolveModelWithRegistry, Pv as DEFAULT_MODEL, R as resolveModelRefFromString, Rf as discoverModels, Ri as resolveUsageProviderId, Rv as shouldEnableShellEnvFallback, Tn as maskApiKey, Up as resolveAuthProfileEligibility, V as resolvePluginProviders, Wp as resolveAuthProfileOrder, Z as getModelsCommandSecretTargetIds, a as createConfigIO, ap as hasUsableCustomProviderApiKey, av as setAuthProfileOrder, cp as resolveEnvApiKey, ep as loadModelCatalog, et as resolveCommandSecretRefsViaGateway, f as setRuntimeConfigSnapshot, gv as resolveAuthProfileDisplayLabel, ip as getCustomProviderApiKey, iv as listProfilesForProvider, j as normalizeProviderId, lo as describeFailoverError, lp as resolveUsableCustomProviderApiKey, lv as loadAuthProfileStoreForRuntime, mv as resolveOpenClawAgentDir, o as loadConfig, op as resolveApiKeyForProvider, ov as upsertAuthProfile, pv as resolveAuthStorePathForDisplay, q as withProgressTotals, rp as shouldSuppressBuiltInModel, sp as resolveAwsSdkEnvVarName, sv as ensureAuthProfileStore, u as readConfigFileSnapshotForWrite, w as findNormalizedProviderValue } from "./send-C3_deGKY.js";
import { x as shortenHomePath } from "./utils-DBcXcVLM.js";
import "./env-overrides-DWTUPhKx.js";
import "./version-D0tcvzW0.js";
import { F as toAgentModelListLike, N as resolveAgentModelFallbackValues, P as resolveAgentModelPrimaryValue, a as resolveAgentDir, d as resolveAgentWorkspaceDir, f as resolveDefaultAgentId, j as resolveDefaultAgentWorkspaceDir, l as resolveAgentModelFallbacksOverride, s as resolveAgentExplicitModelPrimary } from "./agent-scope-CwU5BIqj.js";
...
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent } from "./paths-CtLQlqaT.js";
import "./session-cost-usage-CSeJhdaB.js";
import { a as parseDurationMs } from "./search-manager-rcsEvvDP.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./auth-profiles.runtime-TNhOtZG7.js");
	const { ensureOpenClawModelsJson } = await import("./send-C3_deGKY.js").then((n) => n.tp);
