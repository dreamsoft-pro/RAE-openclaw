...
import { A as theme, O as colorize, p as defaultRuntime } from "./subsystem-G54saDcg.js";
import "./utils-B8zCe27d.js";
import { B_ as resolvePlannedSegmentArgv, Cl as ensureExecApprovals, El as mergeExecApprovalsSocketDefaults, G_ as unwrapKnownDispatchWrapperInvocation, Gl as evaluateExecAllowlist, H_ as resolveExecutableFromPathEnv, Ho as resolveSystemRunCommandRequest, Il as saveExecApprovals, J_ as resolveInlineCommandMatch, Jm as createBrowserRouteDispatcher, K_ as unwrapKnownShellMultiplexerInvocation, Kl as evaluateShellAllowlist, Ko as normalizeSystemRunApprovalPlan, Ll as requestJsonlSocket, Ml as recordAllowlistUse, Nl as requiresExecApproval, Nm as writeJsonAtomic, Ol as normalizeExecApprovals, Pl as resolveExecApprovals, Sl as addAllowlistEntry, Tm as GATEWAY_CLIENT_NAMES, U_ as POSIX_SHELL_WRAPPERS, Ul as resolveExecSafeBinRuntimePolicy, V_ as resolveCommandResolutionFromArgv, Vl as isInterpreterLikeSafeBin, Vo as formatExecCommand, W_ as normalizeExecutableToken, Xm as startBrowserControlServiceFromConfig, Xt as resolveGatewayConnectionAuth, Y_ as splitShellArgs, Ym as createBrowserControlContext, br as withTimeout, bu as getMachineDisplayName, d_ as loadConfig, dv as VERSION, hs as GatewayClient, jl as readExecApprovalsSnapshot, q as formatHelpExamples, q_ as POSIX_INLINE_COMMAND_FLAGS, ql as resolveAllowAlwaysPatterns, rh as resolveBrowserConfig, ul as loadOrCreateDeviceIdentity, wm as GATEWAY_CLIENT_MODES, z_ as analyzeArgvCommand } from "./reply-cpXZjA1O.js";
import { i as resolveAgentConfig } from "./agent-scope-DmTcOjk4.js";
import { s as sameFileIdentity } from "./openclaw-root-B5jXk2td.js";
...
import { S as sanitizeSystemRunEnvOverrides, x as sanitizeHostExecEnv } from "./env-overrides-BYyMsIvB.js";
import "./registry-aHEgjCIQ.js";
import "./skills-BtMFdOkk.js";
import "./frontmatter-BngyYhS0.js";
import "./plugins-om7vnHk0.js";
import { N as detectMime } from "./query-expansion-BNb6Vys6.js";
...
import { l as buildNodeServiceEnvironment, n as resolveDaemonInstallRuntimeInputs, p as resolveNodeProgramArguments, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-_2PUY3Nl.js";
