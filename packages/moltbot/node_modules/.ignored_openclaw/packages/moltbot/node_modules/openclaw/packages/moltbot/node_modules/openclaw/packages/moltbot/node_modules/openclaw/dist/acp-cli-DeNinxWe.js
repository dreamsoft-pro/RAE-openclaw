...
import { C_ as isKnownCoreToolId, Ks as buildGatewayConnectionDetails, ac as GatewayClient, hh as GATEWAY_CLIENT_NAMES, mh as GATEWAY_CLIENT_MODES, o as loadConfig, qt as resolveGatewayConnectionAuth, wv as listThinkingLevels } from "./send-C3_deGKY.js";
...
import { M as resolveWindowsSpawnProgram, j as materializeWindowsSpawnProgram } from "./query-expansion-Cd6sO7e-.js";
...
import { i as omitEnvKeysCaseInsensitive, n as listKnownProviderAuthEnvVarNames } from "./provider-env-vars-C9Hav5xj.js";
import { t as DANGEROUS_ACP_TOOLS } from "./dangerous-tools-DqZ6u2zf.js";
...
async function createAcpClient(opts = {}) {
	...
	const { getActiveSkillEnvKeys } = await import("./env-overrides.runtime-D6ZRdEBx.js");
