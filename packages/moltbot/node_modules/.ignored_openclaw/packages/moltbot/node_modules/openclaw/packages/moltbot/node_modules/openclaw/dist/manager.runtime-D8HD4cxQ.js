...
import { $t as toAcpRuntimeError, At as buildOutboundSessionContext, B as resolveSendPolicy, Bn as createMediaAttachmentCache, Ci as supportsXHighThinking, Ct as normalizeReplyPayload, Fr as isInternalMessageChannel, I as getRemoteSkillEligibility, Ir as normalizeMessageChannel, It as resolveMessageChannelSelection, J as prepareSessionManagerForRun, Jn as loadModelCatalog, L as getSkillsSnapshotVersion, Lr as resolveMessageChannel, Lt as runWithModelFallback, M as setCliSessionId, Mn as textToSpeech, Mr as INTERNAL_MESSAGE_CHANNEL, Mt as formatOutboundPayloadLog, N as runCliAgent, Nn as parseTtsDirectives, Nr as isDeliverableMessageChannel, Nt as normalizeOutboundPayloads, Oi as DEFAULT_MODEL, Ot as resolveOutboundTarget, P as applyVerboseOverride, Pr as isGatewayMessageChannel, Pt as normalizeOutboundPayloadsForJson, Qt as getAcpSessionManager, R as clearSessionAuthProfileOverride, Rt as FailoverError, Si as normalizeVerboseLevel, Sn as formatDiscordUserTag, Un as runCapability, Vn as normalizeMediaAttachments, Wt as clearBootstrapSnapshotOnSessionRollover, Xn as emitSessionTranscriptUpdate, Xt as isSilentReplyPrefixText, Y as resolveBootstrapWarningSignaturesSeen, Yn as resolveSessionTranscriptFile, Zn as loadSessionStore, Zt as isSilentReplyText, _i as ensureAuthProfileStore, _n as formatMention, _t as deriveSessionTotalTokens, a as normalizeProviderId, ar as resolveChannelResetConfig, at as resolveAgentTimeoutMs, bi as formatXHighModelHint, c as resolveThinkingDefault, cr as mergeSessionEntry, ct as clearAgentRunContext, di as buildWorkspaceSkillSnapshot, dr as getChannelPlugin, dt as resolveAcpSessionCwd, fn as resolveAgentRoute, fr as normalizeChannelId, ft as resolveAcpAgentPolicyError, gt as applyModelOverrideToSessionEntry, hi as setRuntimeConfigSnapshot, ht as AGENT_LANE_SUBAGENT, i as normalizeModelRef, ir as evaluateSessionFreshness, j as getCliSessionId, jn as resolveTtsConfig, jt as deliverOutboundPayloads, ki as DEFAULT_PROVIDER, kt as resolveSessionDeliveryTarget, l as getAgentRuntimeCommandSecretTargetIds, lr as setSessionRuntimeModel, lt as emitAgentEvent, mi as readConfigFileSnapshotForWrite, mt as AGENT_LANE_NESTED, n as isCliProvider, nr as normalizeAccountId, o as resolveConfiguredModelRef, or as resolveSessionResetPolicy, ot as formatAgentInternalEventsForPrompt, pi as loadConfig, pt as resolveAcpDispatchPolicyError, q as runEmbeddedPiAgent, r as modelKey, ri as formatErrorMessage, rr as resolveSessionKey, s as resolveDefaultModelForAgent, sr as resolveSessionResetType, st as normalizeSpawnedRunMetadata, t as buildAllowedModelSet, tr as updateSessionStore, u as resolveCommandSecretRefsViaGateway, ur as resolveExplicitAgentSessionKey, ut as registerAgentRunContext, vi as formatCliCommand, vt as hasNonzeroUsage, w as isDangerousNameMatchingEnabled, xi as normalizeThinkLevel, xn as resolveDiscordOwnerAccess, yi as formatThinkingLevels, yt as resolveContextTokensForModel, zn as buildProviderRegistry } from "./model-selection-C2ivQITV.js";
...
function createDefaultDeps() {
	return {
		whatsapp: createLazySender("whatsapp", () => import("./web-CFxAWPhT.js"), "sendMessageWhatsApp"),
		telegram: createLazySender("telegram", () => import("./model-selection-C2ivQITV.js").then((n) => n.h), "sendMessageTelegram"),
		discord: createLazySender("discord", () => import("./model-selection-C2ivQITV.js").then((n) => n.gn), "sendMessageDiscord"),
		slack: createLazySender("slack", () => import("./model-selection-C2ivQITV.js").then((n) => n._), "sendMessageSlack"),
		signal: createLazySender("signal", () => import("./model-selection-C2ivQITV.js").then((n) => n.Ft), "sendMessageSignal"),
		imessage: createLazySender("imessage", () => import("./model-selection-C2ivQITV.js").then((n) => n.v), "sendMessageIMessage")
	};
}
//#endregion
