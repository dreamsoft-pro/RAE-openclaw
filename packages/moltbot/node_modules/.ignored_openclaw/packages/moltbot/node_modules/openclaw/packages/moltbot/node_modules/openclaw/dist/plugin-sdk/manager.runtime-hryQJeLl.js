...
import { $i as normalizeAccountId, $n as resolveMessageChannelSelection, As as DEFAULT_MODEL, Bo as resolveMessageChannel, Bt as resolveSendPolicy, C as resolveThinkingDefault, Ci as buildProviderRegistry, Cn as normalizeReplyPayload, Ct as runCliAgent, Di as runCapability, Es as ensureAuthProfileStore, Fo as INTERNAL_MESSAGE_CHANNEL, Ft as getSkillsSnapshotVersion, Gi as resolveSessionTranscriptFile, Gn as buildOutboundSessionContext, Io as isDeliverableMessageChannel, It as clearSessionAuthProfileOverride, Jn as normalizeOutboundPayloads, Jt as prepareSessionManagerForRun, Ki as emitSessionTranscriptUpdate, Kn as deliverOutboundPayloads, Lo as isGatewayMessageChannel, Ot as getRemoteSkillEligibility, Pi as loadModelCatalog, Ro as isInternalMessageChannel, S as resolveDefaultModelForAgent, St as setCliSessionId, T as resolveCommandSecretRefsViaGateway, Ti as normalizeMediaAttachments, Tt as applyVerboseOverride, Un as resolveOutboundTarget, Ur as resolveAgentRoute, Wn as resolveSessionDeliveryTarget, Xi as updateSessionStore, Yn as normalizeOutboundPayloadsForJson, Yr as formatMention, Yt as resolveBootstrapWarningSignaturesSeen, _ as isCliProvider, _n as deriveSessionTotalTokens, _r as isSilentReplyText, a as readConfigFileSnapshotForWrite, aa as mergeSessionEntry, an as resolveAgentTimeoutMs, b as normalizeProviderId, br as getAcpSessionManager, ca as getChannelPlugin, cn as clearAgentRunContext, cs as formatErrorMessage, dn as resolveAcpSessionCwd, ea as resolveSessionKey, er as runWithModelFallback, et as isDangerousNameMatchingEnabled, fn as resolveAcpAgentPolicyError, g as buildAllowedModelSet, gi as parseTtsDirectives, gn as applyModelOverrideToSessionEntry, gr as isSilentReplyPrefixText, gs as buildWorkspaceSkillSnapshot, hi as textToSpeech, hn as AGENT_LANE_SUBAGENT, i as loadConfig, ia as resolveSessionResetType, js as DEFAULT_PROVIDER, la as normalizeChannelId, ln as emitAgentEvent, mi as resolveTtsConfig, mn as AGENT_LANE_NESTED, na as resolveChannelResetConfig, ni as formatDiscordUserTag, o as setRuntimeConfigSnapshot, oa as setSessionRuntimeModel, on as formatAgentInternalEventsForPrompt, pn as resolveAcpDispatchPolicyError, qi as loadSessionStore, qn as formatOutboundPayloadLog, qt as runEmbeddedPiAgent, ra as resolveSessionResetPolicy, sa as resolveExplicitAgentSessionKey, sn as normalizeSpawnedRunMetadata, ta as evaluateSessionFreshness, ti as resolveDiscordOwnerAccess, tr as FailoverError, un as registerAgentRunContext, ur as clearBootstrapSnapshotOnSessionRollover, v as modelKey, vn as hasNonzeroUsage, w as getAgentRuntimeCommandSecretTargetIds, wi as createMediaAttachmentCache, x as resolveConfiguredModelRef, xt as getCliSessionId, y as normalizeModelRef, yn as resolveContextTokensForModel, zo as normalizeMessageChannel } from "./thread-bindings-DxarhdX6.js";
...
import { a as defaultRuntime, d as logVerbose, m as shouldLogVerbose, t as createSubsystemLogger } from "./subsystem-DOh66yR6.js";
import "./utils-BhiRkVxe.js";
import "./fetch-Cqwcg-Kq.js";
import "./exec-88qB5pUO.js";
import { f as supportsXHighThinking, l as normalizeVerboseLevel, n as formatXHighModelHint, s as normalizeThinkLevel, t as formatThinkingLevels } from "./thinking-B2k7q5lY.js";
import { At as ensureAgentWorkspace, R as resolveStorePath, bt as resolveSessionAgentId, ft as resolveAgentDir, gt as resolveAgentWorkspaceDir, ht as resolveAgentSkillsFilter, ut as listAgentIds, vt as resolveEffectiveModelFallbacks } from "./query-expansion-ChYs46vb.js";
...
import { c as toAcpRuntimeError } from "./registry-N-tffRct.js";
...
function createDefaultDeps() {
	return {
		whatsapp: createLazySender("whatsapp", () => import("./web-xdWELUOK.js"), "sendMessageWhatsApp"),
		telegram: createLazySender("telegram", () => import("./thread-bindings-DxarhdX6.js").then((n) => n.I), "sendMessageTelegram"),
		discord: createLazySender("discord", () => import("./thread-bindings-DxarhdX6.js").then((n) => n.Jr), "sendMessageDiscord"),
		slack: createLazySender("slack", () => import("./thread-bindings-DxarhdX6.js").then((n) => n.B), "sendMessageSlack"),
		signal: createLazySender("signal", () => import("./thread-bindings-DxarhdX6.js").then((n) => n.Zn), "sendMessageSignal"),
		imessage: createLazySender("imessage", () => import("./thread-bindings-DxarhdX6.js").then((n) => n.H), "sendMessageIMessage")
	};
}
//#endregion
