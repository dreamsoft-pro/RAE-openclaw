import { p as defaultRuntime, t as createSubsystemLogger } from "./subsystem-BKSEV_2a.js";
import { Ad as getAcpSessionManager, Ai as AGENT_LANE_NESTED, Av as normalizeVerboseLevel, B as resolveThinkingDefault, Ba as formatOutboundPayloadLog, Bm as setSessionRuntimeModel, Cn as setCliSessionId, Di as resolveAcpDispatchPolicyError, E as isCliProvider, Ei as resolveAcpAgentPolicyError, F as resolveConfiguredModelRef, Fa as resolveSessionDeliveryTarget, Fm as resolveChannelResetConfig, Fv as DEFAULT_PROVIDER, Ha as normalizeOutboundPayloadsForJson, I as resolveDefaultModelForAgent, Im as resolveSessionResetPolicy, La as buildOutboundSessionContext, Lm as resolveSessionResetType, Mv as supportsXHighThinking, Nm as resolveSessionKey, Nn as getRemoteSkillEligibility, Nr as runEmbeddedPiAgent, O as modelKey, Od as isSilentReplyPrefixText, Ov as normalizeThinkLevel, Pa as resolveOutboundTarget, Pi as applyModelOverrideToSessionEntry, Pm as evaluateSessionFreshness, Pr as prepareSessionManagerForRun, Pv as DEFAULT_MODEL, Ra as deliverOutboundPayloads, Rm as mergeSessionEntry, S as buildAllowedModelSet, Sn as getCliSessionId, Sv as formatXHighModelHint, Ti as resolveAcpSessionCwd, Um as resolveExplicitAgentSessionKey, Va as normalizeOutboundPayloads, Vr as resolveBootstrapWarningSignaturesSeen, Y as getAgentRuntimeCommandSecretTargetIds, ah as isDeliverableMessageChannel, bi as clearAgentRunContext, ch as isInternalMessageChannel, co as FailoverError, dh as resolveMessageChannel, dr as clearSessionAuthProfileOverride, ep as loadModelCatalog, et as resolveCommandSecretRefsViaGateway, f as setRuntimeConfigSnapshot, gi as normalizeSpawnedRunMetadata, hi as formatAgentInternalEventsForPrompt, ih as INTERNAL_MESSAGE_CHANNEL, im as emitSessionTranscriptUpdate, io as resolveMessageChannelSelection, j as normalizeProviderId, jd as toAcpRuntimeError, ji as AGENT_LANE_SUBAGENT, k as normalizeModelRef, kd as isSilentReplyText, kn as applyVerboseOverride, lr as getSkillsSnapshotVersion, mi as resolveAgentTimeoutMs, nd as clearBootstrapSnapshotOnSessionRollover, o as loadConfig, oa as normalizeReplyPayload, om as loadSessionStore, sh as isGatewayMessageChannel, so as runWithModelFallback, sv as ensureAuthProfileStore, ta as resolveContextTokensForModel, tm as resolveSessionTranscriptFile, u as readConfigFileSnapshotForWrite, uh as normalizeMessageChannel, um as updateSessionStore, wi as registerAgentRunContext, wn as runCliAgent, wr as resolveSendPolicy, xi as emitAgentEvent, xv as formatThinkingLevels, ym as normalizeAccountId } from "./send-C3_deGKY.js";
import { c as normalizeAgentId, l as normalizeMainKey, u as resolveAgentIdFromSessionKey } from "./session-key-51LnISpq.js";
import { D as ensureAgentWorkspace, a as resolveAgentDir, d as resolveAgentWorkspaceDir, h as resolveSessionAgentId, p as resolveEffectiveModelFallbacks, r as listAgentIds, u as resolveAgentSkillsFilter } from "./agent-scope-CwU5BIqj.js";
import { t as formatCliCommand } from "./command-format-DTVtsTWP.js";
import { r as normalizeChannelId, t as getChannelPlugin } from "./plugins-9Dsb9585.js";
import { r as buildWorkspaceSkillSnapshot } from "./skills-Dm6Oukfq.js";
import { l as resolveStorePath } from "./paths-CtLQlqaT.js";
import { d as deriveSessionTotalTokens, f as hasNonzeroUsage } from "./session-cost-usage-CSeJhdaB.js";
import { n as createDefaultDeps, t as createOutboundSendDeps } from "./outbound-send-deps-BdJDUpuW.js";
