...
import { B as shouldLogVerbose, Q as resolvePreferredOpenClawTmpDir, R as logVerbose, a as createSubsystemLogger, l as defaultRuntime } from "./logger-Budylr6i.js";
...
function createDefaultDeps() {
	return {
		whatsapp: createLazySender("whatsapp", () => import("./web-CtaeCUP5.js"), "sendMessageWhatsApp"),
		telegram: createLazySender("telegram", () => import("./auth-profiles-DrqEIQrq.js").then((n) => n.v), "sendMessageTelegram"),
		discord: createLazySender("discord", () => import("./auth-profiles-DrqEIQrq.js").then((n) => n.Jn), "sendMessageDiscord"),
		slack: createLazySender("slack", () => import("./auth-profiles-DrqEIQrq.js").then((n) => n.b), "sendMessageSlack"),
		signal: createLazySender("signal", () => import("./auth-profiles-DrqEIQrq.js").then((n) => n.Ht), "sendMessageSignal"),
		imessage: createLazySender("imessage", () => import("./auth-profiles-DrqEIQrq.js").then((n) => n.x), "sendMessageIMessage")
	};
}
//#endregion
