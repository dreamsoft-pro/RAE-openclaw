...
import { A as theme, O as colorize, k as isRich$1, p as defaultRuntime } from "./subsystem-G54saDcg.js";
import { S as shortenHomePath } from "./utils-B8zCe27d.js";
import { $ as resolveCommandSecretRefsViaGateway, A as normalizeProviderId, Av as resolveAuthProfileDisplayLabel, B as resolvePluginProviders, C as findNormalizedProviderValue, Cv as loadAuthProfileStoreForRuntime, D as modelKey, Dv as resolveAuthStorePathForDisplay, F as resolveDefaultModelForAgent, Gd as resolveModelWithRegistry, Iv as DEFAULT_MODEL, Jd as discoverAuthStorage, K as withProgressTotals, L as resolveModelRefFromString, Lv as DEFAULT_PROVIDER, Nt as openUrl, Ov as resolveOpenClawAgentDir, P as resolveConfiguredModelRef, S as buildModelAliasIndex, T_ as parseDurationMs, Wg as resolveSecretRefString, X as getModelsCommandSecretTargetIds, Yd as discoverModels, __ as setRuntimeConfigSnapshot, _f as resolveApiKeyForProvider, ba as describeFailoverError, bf as resolveUsableCustomProviderApiKey, bv as upsertAuthProfile, c as buildAuthHealthSummary, d_ as loadConfig, ep as resolveAuthProfileEligibility, ff as loadModelCatalog, gf as hasUsableCustomProviderApiKey, h_ as readConfigFileSnapshotForWrite, hf as getCustomProviderApiKey, hv as shouldEnableShellEnvFallback, j as parseModelRef, l as formatRemainingShort, li as formatUsageWindowSummary, mf as shouldSuppressBuiltInModel, mv as getShellEnvAppliedKeys, np as clearAuthProfileCooldown, o as maskApiKey, qf as isNonSecretApiKeyMarker, rp as resolveProfileUnusableUntilForDisplay, s as DEFAULT_OAUTH_WARN_MS, si as loadProviderUsageSummary, sr as runEmbeddedPiAgent, tp as resolveAuthProfileOrder, u_ as createConfigIO, ui as resolveUsageProviderId, vf as resolveAwsSdkEnvVarName, vv as listProfilesForProvider, xv as ensureAuthProfileStore, yf as resolveEnvApiKey, yv as setAuthProfileOrder } from "./reply-cpXZjA1O.js";
import { F as toAgentModelListLike, N as resolveAgentModelFallbackValues, P as resolveAgentModelPrimaryValue, a as resolveAgentDir, d as resolveAgentWorkspaceDir, f as resolveDefaultAgentId, j as resolveDefaultAgentWorkspaceDir, l as resolveAgentModelFallbacksOverride, s as resolveAgentExplicitModelPrimary } from "./agent-scope-DmTcOjk4.js";
...
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent } from "./paths-CfmKJcO5.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./auth-profiles.runtime-D5DNTmPQ.js");
	const { ensureOpenClawModelsJson } = await import("./reply-cpXZjA1O.js").then((n) => n.pf);
