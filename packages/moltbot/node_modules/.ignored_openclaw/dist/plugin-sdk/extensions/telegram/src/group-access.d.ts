...
import type { TelegramAccountConfig, TelegramDirectConfig, TelegramGroupConfig, TelegramTopicConfig } from "../../../src/config/types.js";
...
}) => import("../../../src/config/runtime-group-policy.js").RuntimeGroupPolicyResolution;
