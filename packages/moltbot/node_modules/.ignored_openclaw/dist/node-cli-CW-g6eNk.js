import { A as theme, O as colorize, p as defaultRuntime } from "./subsystem-BKSEV_2a.js";
import { g as resolveStateDir } from "./paths-dQ_clcF4.js";
import "./boolean-BHdNsbzF.js";
import { Bh as createBrowserRouteDispatcher, Cu as requiresExecApproval, Du as requestJsonlSocket, Eu as saveExecApprovals, Fu as evaluateExecAllowlist, Gu as POSIX_SHELL_WRAPPERS, Hh as startBrowserControlServiceFromConfig, Hu as resolvePlannedSegmentArgv, Is as normalizeSystemRunApprovalPlan, Iu as evaluateShellAllowlist, J as formatHelpExamples, Ju as unwrapKnownShellMultiplexerInvocation, Kr as withTimeout, Ku as normalizeExecutableToken, Lu as resolveAllowAlwaysPatterns, Ms as resolveSystemRunCommandRequest, Nu as resolveExecSafeBinRuntimePolicy, Sd as getMachineDisplayName, Su as recordAllowlistUse, Th as writeJsonAtomic, Uu as resolveCommandResolutionFromArgv, Vh as createBrowserControlContext, Vu as analyzeArgvCommand, Wu as resolveExecutableFromPathEnv, Xu as resolveInlineCommandMatch, Yh as resolveBrowserConfig, Yu as POSIX_INLINE_COMMAND_FLAGS, ac as GatewayClient, eu as loadOrCreateDeviceIdentity, fu as addAllowlistEntry, gu as mergeExecApprovalsSocketDefaults, hh as GATEWAY_CLIENT_NAMES, js as formatExecCommand, ju as isInterpreterLikeSafeBin, mh as GATEWAY_CLIENT_MODES, o as loadConfig, pu as ensureExecApprovals, qt as resolveGatewayConnectionAuth, qu as unwrapKnownDispatchWrapperInvocation, vu as normalizeExecApprovals, wu as resolveExecApprovals, xu as readExecApprovalsSnapshot } from "./send-C3_deGKY.js";
import "./utils-DBcXcVLM.js";
import { S as sanitizeSystemRunEnvOverrides, x as sanitizeHostExecEnv } from "./env-overrides-DWTUPhKx.js";
import { t as VERSION } from "./version-D0tcvzW0.js";
import { i as resolveAgentConfig } from "./agent-scope-CwU5BIqj.js";
import { a as sameFileIdentity } from "./boundary-file-read-Bb0WDUIN.js";
import { i as logWarn } from "./logger-6-BbUobc.js";
...
import { N as detectMime } from "./query-expansion-Cd6sO7e-.js";
...
import { _ as resolveNodeWindowsTaskName, c as formatNodeServiceDescription, g as resolveNodeSystemdServiceName, h as resolveNodeLaunchAgentLabel } from "./constants-w22BuGMD.js";
import { i as splitShellArgs } from "./search-manager-rcsEvvDP.js";
...
import { l as buildNodeServiceEnvironment, n as resolveDaemonInstallRuntimeInputs, p as resolveNodeProgramArguments, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-CYiptEdb.js";
import "./runtime-guard-Bk0rI8d9.js";
import { r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-CjlHpTU-.js";
import "./runtime-parse-DwIldjg_.js";
import "./launchd-DaQfJlhP.js";
import "./service-CXKirQDx.js";
import "./systemd-D38NY5Ac.js";
import { _ as installDaemonServiceAndEmit, a as createCliStatusTextStyles, g as buildDaemonServiceSnapshot, i as runServiceUninstall, m as resolveRuntimeStatusColor, o as createDaemonInstallActionContext, r as runServiceStop, s as failIfNixDaemonInstallMode, t as runServiceRestart } from "./lifecycle-core-BDO6MPkC.js";
import { c as buildPlatformRuntimeLogHints, l as buildPlatformServiceStartHints, u as formatRuntimeStatus } from "./systemd-hints-DyGeJ1h5.js";
import { t as parsePort } from "./parse-port-CZos_Guw.js";
