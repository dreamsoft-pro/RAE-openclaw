...
import { Dt as formatControlUiSshHint, Ft as probeGatewayReachable, Lt as resolveControlUiLinks, Nt as openUrl, Tt as detectBrowserOpenSupport, Vt as waitForGatewayReachable } from "./reply-cpXZjA1O.js";
import { y as DEFAULT_BOOTSTRAP_FILENAME } from "./agent-scope-DmTcOjk4.js";
...
import { t as runTui } from "./tui-DZbSaJtN.js";
...
async function finalizeOnboardingWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-DwmFZpci.js").then((n) => n.r);
	...
	if (webSearchProvider) {
		const { SEARCH_PROVIDER_OPTIONS, resolveExistingKey, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-DTTCOCr8.js");
		...
		const { SEARCH_PROVIDER_OPTIONS, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-DTTCOCr8.js");
